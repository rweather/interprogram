...
syn match   ipStatement         "\<ROUND TO A MULTIPLE OF\>"
syn match   ipStatement         "\<TRIM STRING\>"
syn match   ipStatement         "\<PAD STRING ON LEFT\>"
syn match   ipStatement         "\<PAD STRING ON RIGHT\>"
syn match   ipStatement         "\<NUMBER TO STRING\>"
syn match   ipStatement         "\<STRING TO NUMBER\>"
syn match   ipStatement         "\<STRING TO INTEGER\>"
syn match   ipStatement         "\<STRING TO UPPERCASE\>"
syn match   ipStatement         "\<STRING TO LOWERCASE\>"
syn match   ipStatement         "\<STRING TO CHARACTER CODE\>"
syn match   ipStatement         "\<CHARACTER CODE TO STRING\>"
